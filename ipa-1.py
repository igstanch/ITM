...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    consumed_materials = num_jobs * job_consumption
    materials_after_consumption = total_material - consumed_materials
    remaining_materials = str(materials_after_consumption) + (material_units)
